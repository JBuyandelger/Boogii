...
<?php 
   ...
   {
      $id = $_GET['id'];
      $sql2 = "SELECT * FROM t_teatured-models WHERE id=$id ";
...
?>
            ...
            <tr>
               <td>Онцлох : </td>
               <td>
                  <input <?php if($featured=="yes") {echo "checked";}?>type="radio" name="fuetured" value="yes">Тийм
                  <input <?php if($featured=="no") {echo "checked";}?>type="radio" name="fuetured" value="no">Үгүй
               </td>
            </tr>
            ...
            <tr>
               <td>Идэвхтэй : </td>
               <td>
               <input <?php if($featured=="yes"){echo "checked";}?>type="radio" name="active" value="yes">Тийм
               <input <?php if($featured=="no"){echo "checked";}?>type="radio" name="active" value="no">Үгүй
               </td>
            </tr>
